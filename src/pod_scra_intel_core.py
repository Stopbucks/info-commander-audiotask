# ---------------------------------------------------------
# src/pod_scra_intel_core.py v5.9 ( AUDIO_EAT 大腦閘門與絕對深潛防禦 終極版)
...
def run_audio_to_stt_mission(sb=None):
    ...
    for task in tasks:
        ...
        try:
            ...
            # 🛡️ 邊界防禦：如果是未壓縮檔，且此機甲無權壓縮，直接跳過防 OOM
            ...
            # 🚀 第一棒 429 絕對深潛防禦
                ...
                print(f"⚠️ [{worker_id}] 第一棒 API 限流！強制深潛 {penalty_delay:.1f} 秒，放棄本輪剩餘轉譯任務！")
