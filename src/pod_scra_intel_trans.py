# ---------------------------------------------------------
# 程式碼：src/pod_scra_intel_trans.py  (V6.15 更新T2時間限制無效_離線下載擬真版)
